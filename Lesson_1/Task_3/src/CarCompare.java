...
class Main {
    public static void main(String[] args) {
        CarCompare c1 = new CarCompare(170, 8000, "BMW", "Green");
        CarCompare c2 = new CarCompare(175, 2000, "Opel", "Black");
        CarCompare c3 = new CarCompare(175, 10000, "BMW", "White");
        CarCompare c4 = new CarCompare(190, 9000, "Mercedes", "Black");
